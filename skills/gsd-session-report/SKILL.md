...
<execution_context>
@~/.gemini/antigravity/get-shit-done/workflows/session-report.md
</execution_context>

<process>
Execute the session-report workflow from @~/.gemini/antigravity/get-shit-done/workflows/session-report.md end-to-end.
</process>
